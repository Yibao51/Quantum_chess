...
version = 'QuantumChessV1.0 time:' + date
...
class Button:
    def __init__(self, screen, text, x, y, color, enable):  # 构造函数
        ...
        self.enable = enable
        self.font = pygame.font.SysFont('simsunnsimsun', button_h * 2 // 3)
...
class Game:  # pygame类,以下所有功能都是根据需要重写
    def __init__(self, caption):
        ...
        self.buttons = []
        self.buttons.append(WhiteStartButton(self.screen, '选白', 10, map_h))
        self.buttons.append(BlackStartButton(self.screen, '选黑', 170, map_h))
        self.buttons.append(GiveupButton(self.screen, '投降', 330, map_h))
        self.buttons.append(MultiStartButton(self.screen, '双人对战', 490, map_h))
        self.is_play = False
